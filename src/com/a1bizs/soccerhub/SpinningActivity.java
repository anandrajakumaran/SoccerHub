...
import com.a1bizs.soccerhub.carousel.Carousel;
import com.a1bizs.soccerhub.carousel.CarouselAdapter;
import com.a1bizs.soccerhub.carousel.CarouselAdapter.OnItemClickListener;
import com.a1bizs.soccerhub.carousel.CarouselAdapter.OnItemSelectedListener;
...
//				menu.findItem(R.id.favourite).setChecked(true);	
				if(position == 0)
					...
					if(utilityData.isLogin(getApplicationContext()) == true)
		            	...
		            	activity = new Intent(getApplicationContext(), Login.class);
				else if(position == 4)
